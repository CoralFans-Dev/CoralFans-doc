...
+ 您需要使用 `cfsp/core/simPlayer/SimPlayer.h` 。其他头文件定义的函数/数据并没有通过dllexport导出。
...
+ 函数的返回值大多为 `base::OperateResult` 类型，其枚举值见[src/cfsp/base/OperateResult.h](https://github.com/CoralFans-Dev/CFSP/blob/develop/src/cfsp/base/OperateResult.h)。
